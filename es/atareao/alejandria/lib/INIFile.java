...
------------------------------------------------------------------------------*/
    ...
    public void setSectionComments(String pstrSection, String pstrComments){
        INISection objSec   = null;
 ...
 *----------------------------------------------------------------------------*/
    ...
    private String addRemChars(String pstrSrc)
    {
        ...
        //if(pstrSrc == null) return null;
        if((pstrSrc == null)||(pstrSrc.length()<1)) return null;
        while (intPos >= 0)
        {
            intLen = 2;
    ...
    private class INISection
    {
        ...
        public String toString()
        {
            ...
            if (this.mstrComment != null){
                String val=addRemChars(this.mstrComment);
                if(val!=null){
