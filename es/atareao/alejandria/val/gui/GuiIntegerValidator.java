 ...
 */
public class GuiIntegerValidator extends AbstractValidator {
    // <editor-fold defaultstate="collapsed" desc=" Constantes  "> 

    // </editor-fold> 

    // <editor-fold defaultstate="collapsed" desc=" Constructores  "> 
    public GuiIntegerValidator(JDialog parent, JTextField c) {
        super(parent, c, "El valor introducido no es válido, tiene que ser un entero");
    }
    public GuiIntegerValidator(JDialog parent, JTextField c, String message) {
    ...
    protected boolean validationCriteria(JComponent c) {
        ...
        SimpleIntegerValidator snv=new SimpleIntegerValidator(value);
        if(snv.validate()){
            return true;
        }
        return false;
